...
class CheckoutController extends Controller
{
    public function index(Request $request){
        ...
        $key = 'e9f75637b977bfbe11cd0247288275e7'; //Buat akun atau pakai API akun Tahu Coding
        ...
        //load view form
        return view('checkout',compact('provinces','result_cost','name','origin_name','destination_name','data_weight','data_courier'));
    ...
    //     ])->post('https://api.rajaongkir.com/starter/cost'); #ambil api dari rajaongkir
